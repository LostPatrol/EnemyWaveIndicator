...
if(!last){console.log(JSON.stringify({samples:0,conclusion:'No eligible normal-wave timing samples; do not infer lead time or working capture.'},null,2));process.exitCode=2;}
